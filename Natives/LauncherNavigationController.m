...
- (void)viewDidLoad
{
    ...
    PLApplyNavigationAppearance(self);
    PLApplyToolbarAppearance(self.toolbar);
    ...
    UIImageView *leadingIconView = [[UIImageView alloc] initWithImage:[UIImage systemImageNamed:@"shippingbox"]];
    leadingIconView.frame = CGRectMake(0, 0, 40, 40);
    leadingIconView.contentMode = UIViewContentModeCenter;
    leadingIconView.tintColor = PLMutedTextColor();
    self.versionTextField.leftView = leadingIconView;
    UIImageView *trailingIconView = [[UIImageView alloc] initWithImage:[[[UIImage imageNamed:@"SpinnerArrow"] _imageWithSize:CGSizeMake(30, 30)] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate]];
    trailingIconView.tintColor = PLMutedTextColor();
    self.versionTextField.rightView = trailingIconView;
    ...
    PLStyleInputField(self.versionTextField);
    ...
    if(hasLiquidGlass) {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            self.buttonInstallItem.buttonGlassView.backgroundColor = [PLAccentColor() colorWithAlphaComponent:0.68];
        });
        ...
        PLStylePrimaryButton(self.buttonInstall);
    ...
    self.progressViewMain.trackTintColor = [UIColor.tertiarySystemFillColor colorWithAlphaComponent:0.7];
    self.progressViewMain.progressTintColor = PLSecondaryAccentColor();
    ...
    self.progressText.textColor = PLMutedTextColor();
